              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item active">
                    <a class="nav-link" href="DOV_Mail.html">Mail <span class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item">
                  ...
                  <div class="col-sm-9">
                      <div class="container">
                          <ul class="nav nav-tabs"  role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active"  data-toggle="tab" href="#Voluntary Requests">Voluntary Requests</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" data-toggle="tab" href="#Intiative Suggestions">Intiative Suggestions</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link"  data-toggle="tab" href="#Finish Reports">Finish Reports</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link"  data-toggle="tab" href="#Requested Volunteers">Requested Volunteers</a>
                            </li>
                          </ul>
