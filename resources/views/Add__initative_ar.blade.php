...
<html lang="ar" dir="rtl">
    ...
    <body>
        ...
        <div class="container-fluid title text-center">
            <h1 class="p-4 display-4 title text-center m-0 p-0">
                اضافة مبادرة
            </h1>
        </div>
            ...
            >
                ...
                <div class="form-group my-4">
                    ...
                    >
                        ...
                        <option id="North_Gaza" value="North Gaza">
                            شمال غزة
                        </option>
                        <option id="Gaza" value="Gaza">غزة</option>
                        <option id="Wosta" value="Wosta">وسطة</option>
                        <option id="Khan_Younes" value="Khan Younes">
                            خان يونس
                        </option>
                ...
                <div class="form-group my-4">
                    <label for="Initative_details" class="mb-2"
                        >تفاصيل المبادرة<span class="text-danger">*</span
                        >:</label
                    >
                    <textarea
                        class="form-control"
        ...
        >
            ...
            <div>
                ...
                ></a>
                <a href="#" class="social"
                    ><i class="fab fa-flickr flicker"></i
                ></a>
                <a href="#" class="social"
                    ><i
            ...
            (function () {
                ...
                window.addEventListener(
                    ...
                    function () {
                        ...
                        var forms =
                            document.getElementsByClassName("validation");
